...
class MakerTakerReturnsByCategoryAnalysis(Analysis):
    ...
    def __init__(
        ...
        super().__init__(
            name="maker_taker_returns_by_event_category",
            description="Maker vs taker excess returns by market's event category",
        )
    ...
    def run(self) -> AnalysisOutput:
        ...
        df = con.execute(
            ...
            WITH resolved_markets AS (
                SELECT ticker, event_category, result
